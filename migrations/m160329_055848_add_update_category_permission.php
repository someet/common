...
class m160329_055848_add_update_category_permission extends Migration
{
    public function up()
    {
        $items = [
            /* 黄牌系统 */
            '/backend/member/update-category' => ['founder'],
        ];
...
SQL;
    ...
    {
        echo "m160329_055848_add_update_category_permission cannot be reverted.\n";
