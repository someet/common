...
class m160718_110826_add_city_manage_permission extends Migration
{
    public function up()
    {
        $items = [
            '/backend/city/index' => ['founder'],
            '/backend/city/create' => ['admin'],
            '/backend/city/switch' => ['founder'],
            '/backend/city/update' => ['admin'],
            '/backend/city/view' => ['founder'],
        ];
...
SQL;
    ...
    {
        echo "m160718_110826_add_city_manage_permission cannot be reverted.\n";
