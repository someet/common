...
class m160210_075520_add_founder_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/member/preview-feedback' => ['founder'],
        ];
...
SQL;
    ...
    {
        echo "m160210_075520_add_founder_permission cannot be reverted.\n";
