...
class m160210_082743_add_activity_view_founder_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/member/activity-view' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m160210_082743_add_activity_view_founder_permission cannot be reverted.\n";
