...
class m160318_092225_appeal_list_permission extends Migration
{
    public function up()
    {
        $items = [
            /* 黄牌系统 */
            '/backend/member/appeal-list' => ['founder'],
        ];
...
SQL;
    ...
    {
        echo "m160318_092225_appeal_list_permission cannot be reverted.\n";
