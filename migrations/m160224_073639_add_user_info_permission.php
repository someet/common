...
class m160224_073639_add_user_info_permission extends Migration
{
    public function up()
    {
        $items = [
            '/mobile/member/user-info' => ['user'],
        ];
...
SQL;
    ...
    {
        echo "m160224_073639_add_user_info_permission cannot be reverted.\n";
