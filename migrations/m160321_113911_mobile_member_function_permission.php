...
class m160321_113911_mobile_member_function_permission extends Migration
{
    public function up()
    {
        $items = [
            /* 发起人统计 */
            '/mobile/member/user-founder-count' =>['user'],
            '/mobile/member/is-feedback' =>['user'],
        ];
...
SQL;
    ...
    {
        echo "m160321_113911_mobile_member_function_permission cannot be reverted.\n";
